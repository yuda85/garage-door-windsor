...
$to_2 = 'cashmemphisoffer@gmail.com';
...
try {
   ...
   // $mail->Host = '192.168.160.7';  					// Specify main and backup SMTP servers
    ...
    //Recipients
    $mail->setFrom('noreply@sellhousefastmemphis.com','Memphis - Website step 2 Lead ');
    $mail->addAddress($to, $name);     // Add a recipient            // Name is optional
    $mail->addAddress($to_2, $name);     // Add a recipient            // Name is optional
    $mail->addReplyTo('noreply@sellhousefastmemphis.com', 'Memphis - Website step 2  Lead');
	$mail->CharSet = 'UTF-8';

    //Content
    $mail->isHTML(true);                                  // Set email format to HTML
    $mail->Subject = 'Step 2 lead from Memphis Website Extended Form ';
    $mail->Body    = '<h1>Step 2 Lead from Memphis Website Extended Form</h1><br/>
