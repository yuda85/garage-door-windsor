...
try {
   ...
   // $mail->Host = '192.168.160.7';  					// Specify main and backup SMTP servers
    ...
    //Recipients
    $mail->setFrom('noreply@mikegaragedoorrepairomaha.com','Omaha NE Website Form Lead');
    $mail->addAddress($to, $name);     // Add a recipient            // Name is optional
    $mail->addAddress($to_2, $name);     // Add a recipient            // Name is optional
    $mail->addReplyTo('noreply@mikegaragedoorrepairomaha.com', 'Omaha NE Website Form Lead');
	$mail->CharSet = 'UTF-8';

    //Content
    $mail->isHTML(true);                                  // Set email format to HTML
    $mail->Subject = 'Omaha NE Website Form Lead';
    $mail->Body    = '<h1>Omaha NE Website Form Lead</h1><br/>
